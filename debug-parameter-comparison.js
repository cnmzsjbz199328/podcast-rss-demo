...
function buildDeploymentParams(style = 'news-anchor') {
  ...
  // 模拟部署系统的脚本内容
  const deploymentScript = `好的，这是一份专业News播报员风格的Podcast脚本，整合了您提供的News内容：

---

**(开场音乐渐弱)**

**播报员：** 各位听众，大家好，欢迎收听由[Podcast名称，此处可填：全球News速览/焦点透视]为您带来的今日News快报。我是您的播报员[您的姓名，此处可省略]。

今天，我们将聚焦三则重要的国际News：英国一项揭露非法劳工网络的深度调查、法国一桩驾车冲撞人群的恶性事件，以及英国移民政策执行的最新进展。
...
**播报员：** 今天的《News快报》就到这里。感谢您的收听，我们将持续为您关注这些事件的最新进展。
